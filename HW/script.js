...
const questions = "https://my-json-server.typicode.com/depth0/survey1/questions/";
let l;
const submitData = (e) => {
  e.preventDefault();
...
console.log("je suis dans s");
    l = 'https://my-json-server.typicode.com/depth0/survey1/surveys/1';
  } else if (option === "B") {
console.log("je suis dans s");
    l = 'https://my-json-server.typicode.com/depth0/survey1/surveys/2';
  } 
